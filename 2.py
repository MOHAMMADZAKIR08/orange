...
def load_data():
    try:
        ...
        for entry in data:
            ...
            elif isinstance(entry['Payment History'], str):
...
# Save data to CSV
def save_data():
    # Ensure all entries have Payment History
...
def add_entry(date, holder_name, mobile_name, mobile_rate, paid):
    ...
    new_entry = {
        ...
        "Paid": paid,
        "Payment History": [{"Date": date, "Amount": paid}]  # Initialize payment history
    }
